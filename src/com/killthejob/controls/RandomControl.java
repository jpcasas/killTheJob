 ...
 * @author Juan
 */
public class RandomControl extends AbstractControl {
    ...
    public RandomControl(int screenWidth, int screenHeight) {
    ...
    protected void controlUpdate(float tpf) {
        if ((Boolean) spatial.getUserData("active")) {
            ...
            Vector3f directionVector = UtilHelper.getVectorFromAngle(directionAngle);
            ...
            if (loc.x > screenWidth || loc.y > screenHeight) {
                ...
                directionAngle = UtilHelper.getAngleFromVector(newDirectionVector);
            }
            ...
            Picture pic = (Picture) spatialNode.getChild("enemyRandom");
